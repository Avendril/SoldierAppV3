...
public class BackgroundWorkerDelete extends AsyncTask<String,Void,String> {
    ...
    protected void onPostExecute(String result) {
        if(result.contains("Please enter both name and surname")){
        ...
        if(result.contains("User has been removed")) {//Checking if the insert was a success (insert.php)
        ...
        {
            alertDialog.setMessage("User wasn't removed due to an error");
